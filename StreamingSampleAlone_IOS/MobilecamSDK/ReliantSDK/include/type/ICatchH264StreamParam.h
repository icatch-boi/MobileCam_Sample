...
class ICAT_API ICatchH264StreamParam : public ICatchStreamParam
{
public:
    ICatchH264StreamParam(int width = 640, int height = 360, int bitrate = 5000000, int frameRate = 30);
...
public:
    string toString();
    static shared_ptr<ICatchH264StreamParam> fromString(string attributes);
