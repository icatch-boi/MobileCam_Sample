...
#ifndef __ICATCH_UVC_DEPTH_TRANSPORT_H__
#define __ICATCH_UVC_DEPTH_TRANSPORT_H__
...
class ICatchUVCDepthTransport : public ICatchITransport
{
public:
    ICatchUVCDepthTransport(int vendorID, int productID, int fileDescriptor);
