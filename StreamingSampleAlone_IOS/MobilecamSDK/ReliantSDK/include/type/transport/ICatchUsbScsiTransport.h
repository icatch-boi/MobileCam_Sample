...
#ifndef __ICATCH_USB_SCSI_TRANSPORT_H__
#define __ICATCH_USB_SCSI_TRANSPORT_H__
...
class ICatchUsbScsiTransport : public ICatchITransport
{
public:
    ICatchUsbScsiTransport(int vendorID, int productID);
