...
#ifndef __ICATCH_UVC_BULK_TRANSPORT_H__
#define __ICATCH_UVC_BULK_TRANSPORT_H__
...
class ICatchUVCBulkTransport : public ICatchITransport
{
public:
    ICatchUVCBulkTransport(int vendorID, int productID);
