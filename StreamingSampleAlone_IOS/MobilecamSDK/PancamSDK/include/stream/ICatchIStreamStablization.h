...
#ifndef __ICATCH_I_STREAM_STABLIZATION_H__
#define __ICATCH_I_STREAM_STABLIZATION_H__
 ...
 */
class ICatchIStreamStablization
{
public:
    virtual ~ICatchIStreamStablization(){ };

public:
    virtual int32_t enableStablization() = 0;
    virtual int32_t disableStablization() = 0;
    virtual int32_t getStablizationInfo(ICatchGLStablizationInfo& stablizationInfo) = 0;
};
