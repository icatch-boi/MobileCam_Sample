...
public class USBHost_Feature
{
    ...
    public static final int USB_PRODUCT_ID      = 0x6503;
    ...
    public USBHost_Feature(Context context, Handler handler)
    {
    ...
    public void setUsbDevice(Context context, int vendorID, int productID)
    {
